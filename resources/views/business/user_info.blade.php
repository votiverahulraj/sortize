            ...
            <div class="row">
              <div class="col-md-12 grid-margin stretch-card">
               <?php
                ...
                <div class="card">
                  <div class="card-body">
                      <a href="{{route('interprise.booking-list')}}" class="btn btn-outline-info btn-fw" style="float: right;">Back</a>
                    ...
                    <div class="tab-content">
                      <div class="tab-pane active" id="home" role="tabpanel" aria-labelledby="home-tab">
                          <div class="row">
                            ...
                            <div class="form-group col-md-6">
                              <input type="hidden" name="user_id" value="">
                              <label for="exampleInputUsername1"><strong>Gender : </strong> {{$gender}}</label>
                            </div>


                            <div class="form-group col-md-6">
                              <input type="hidden" name="user_id" value="">
                              <label for="exampleInputUsername1"><strong>City : </strong> {{$country}}</label>
                            </div>
                            ...
                            <div class="form-group col-md-6">
                              <input type="hidden" name="user_id" value="">
                              <label for="exampleInputUsername1"><strong>Country : </strong>{{  $city }} </label>
                            </div>
                          ...
                          <div class="row">
                             ...
                             <div class="form-group col-md-6">
                              <label for="exampleInputUsername1"><strong>Event Day - Date : </strong> {{$event_days}}</label>
                            </div>
                             <div class="form-group col-md-6">
