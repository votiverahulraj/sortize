...
.error {
  ...
  <div class="reg_wrapper">
    <div class="left_col">
      ...
      <!-- Website Link -->
      <div class="form-group">
        <label class="mb-0 mr-2" style="width: 250px;">Website Link (Optional)</label>
    ...
    <div class="rgt_col">
      ...
      <div class="form-group position-relative" style="min-height: 70px;">
        <div id="commercialNameField" style="display: none; position: absolute; top: 0; left: 0; right: 0;">
          <label class="mb-0 mr-2" style="width: 250px;">Commercial Name (Legal Entity)</label>
      ...
      <div class="form-group">
        <label class="mb-0 mr-2" style="width: 250px;">City (Activity Location)</label>
  ...
  <div class="form-check d-inline-flex align-items-center justify-content-center">
    ...
    <label class="form-check-label mb-0" for="terms">
      <strong>I agree to the <a href="#" target="">Terms and Conditions</a></strong>
    </label>
  </div>
<label id="terms-error" class="error text-danger small mt-1 d-block" for="terms"></label>
</div>
