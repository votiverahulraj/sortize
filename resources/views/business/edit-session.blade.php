...
@section('content')
    ...
    <div class="main-panel">
        <div class="content-wrapper">
            ...
            <form class="add-evnt" id="eventForm" method="POST"
                action="{{ route('interprise.update-session', ['id' => $session->id]) }}" enctype="multipart/form-data">
                {!! csrf_field() !!}
                ...
                <div class="form-group col-md-6">
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <input type="number" name="capacity" value="{{ $session->capacity }}" min="1"
                            class="form-control form-control-sm">
                    </div>
