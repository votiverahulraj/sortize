          ...
          <div class="content-wrapper">
            <div class="row">
              ...
              <div class="col-lg-12 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                  <a href="{{route('admin.addBlog')}}" class="btn btn-outline-info btn-fw" style="float: right;">Add Blog</a>
                    <h4 class="card-title">Blog Management</h4>
                    <p class="card-description"> Blog List 
                    </p>
                        ...
                        <table class="table table-striped" id="example">
                          ...
                          <tbody>
                            ...
                            <tr>
                              ...
                              <td>                              
                                <a href="{{route('admin.addBlog')}}/{{ $list->id }}"><i class="mdi mdi-lead-pencil"></i></a></td>
                            </tr>
                            @php $i++; @endphp 
                            @endforeach
                            @endif
