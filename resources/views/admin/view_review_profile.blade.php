                   ...
                   <div class="row">
                      <div class="col-md-12">
                       <div class="card">
                         ...
                         <div class="card-body">
                           <a href="{{ route('admin.reviewlist') }}" class="btn btn-outline-info btn-sm float-end">Review List</a>
                    ...
                    <div class="card-body">
                       <h5 class="card-title">Review Details</h5>
                         <div class="row">
                            <div class="form-group col-md-6">
                              <input type="hidden" name="user_id" value="{{$user_id}}">
                              <label for="exampleInputUsername1"><strong>Review  : </strong> @if(!empty($review_detail)){{$review_detail->review_text}}@endif</label>
                            </div>
                            <div class="form-group col-md-6">
                              <label for="exampleInputUsername1"><strong>Rating  : </strong>@if(!empty($review_detail)){{$review_detail->rating}}@endif</label>
                            </div>
                            </div>
                          </div>
                       </div>
