          ...
          <div class="content-wrapper">
            <div class="row">
              ...
              <div class="col-lg-12 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                  <a href="{{route('admin.addLanguage')}}" class="btn btn-outline-info btn-fw" style="float: right;">Add Language</a>
                    <h4 class="card-title">Language Management</h4>
                    <p class="card-description"> Language List 
                    </p>
                    <form id="bulkDeleteForm" method="POST" action="{{ route('admin.bulkDeleteLanguage') }}">
                      @csrf
                        ...
                        <table class="table table-striped" id="example">
                          ...
                          <tbody>
                            ...
                            <tr>
                              ...
                              <td>                              
                                <a href="{{route('admin.addLanguage')}}/{{ $list->id }}"><i class="mdi mdi-lead-pencil"></i></a></td>
                            </tr>
                            @php $i++; @endphp 
                            @endforeach
                            @endif
          ...
          document.getElementById('bulkDeleteBtn').addEventListener('click', function (e) {
            ...
            if (checkboxes.length === 0) {
              Swal.fire({
                icon: 'warning',
                title: 'No selection',
                text: 'Please select at least one Language to delete.',
              });
              return;
            }
            ...
            Swal.fire({
              title: 'Are you sure?',
              text: "Selected Languages will be deleted.",
              icon: 'warning',
