          ...
          <div class="content-wrapper">
            <div class="row">
              ...
              <div class="col-lg-12 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                  <a href="{{route('admin.addCoachType')}}" class="btn btn-outline-info btn-fw" style="float: right;">Add Coach Category</a>
                    <h4 class="card-title">Coach Category Management</h4>
                    <p class="card-description"> Coach Category List 
                    </p>
                    <form id="bulkDeleteForm" method="POST" action="{{ route('admin.bulkDeleteCoachCat') }}">
                      @csrf
                        ...
                        <table class="table table-striped" id="example">
                          ...
                          <tbody>
                            ...
                            <tr>
                              ...
                              <td>                              
                                <a href="{{route('admin.addCoachType')}}/{{ $list->id }}"><i class="mdi mdi-lead-pencil" title="Edit Coach Type"></i></a> | 
                                <a href="{{route('admin.coachSubTypeList')}}/{{ $list->id }}"><i class="mdi mdi-format-list-bulleted" title="Coach SubType List"></i></a>
                              </td>
                            </tr>
                            @php $i++; @endphp 
                            @endforeach
        ...
        <script>
          ...
          $(document).ready(function () {
            $(document).on('change','.user_status',function(){
              ...
              $.ajax({
                url: "{{url('/admin/update_type_status')}}",
                type: "POST",
                datatype: "json",
                data: {
                  status: status,
                ...
                success: function(result) {
                  Swal.fire({
                    title: "Success!",
                    text: "Coach category Status updated!",
                    icon: "success"
                  });
                },
                errror: function(xhr) {
